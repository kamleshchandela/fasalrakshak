    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-[#1A6B2F] via-[#0D3D1A] to-[#0a2d14] py-10 px-4">
      ...
      <div className="container mx-auto flex flex-col items-center justify-center relative z-10">
        <div className="mb-4 flex items-center gap-3 rounded-full bg-white/10 px-5 py-2 backdrop-blur-sm">
          ...
          <span className="text-sm font-medium text-white/90">Premium Agri Inputs Store</span>
        </div>
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight">
              FasalRakshak <span className="text-amber-400">Store</span>
            </h1>
          </div>
        </div>
        
        <p className="text-lg md:text-xl text-white/80 max-w-2xl text-center mb-6">
          Quality pesticides, fertilizers, and crop solutions with direct WhatsApp ordering
        </p>
        
        <div className="flex flex-wrap justify-center gap-4">
          <div className="flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 backdrop-blur-sm">
            <Bug className="h-4 w-4 text-green-400" />
            <span className="text-sm font-medium text-white">Pesticides</span>
          </div>
          <div className="flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 backdrop-blur-sm">
            <Leaf className="h-4 w-4 text-green-400" />
            <span className="text-sm font-medium text-white">Fertilizers</span>
          </div>
          <div className="flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 backdrop-blur-sm">
            <Shield className="h-4 w-4 text-green-400" />
            <span className="text-sm font-medium text-white">Crop Protection</span>
          </div>
          <div className="flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 backdrop-blur-sm">
            <Droplets className="h-4 w-4 text-green-400" />
            <span className="text-sm font-medium text-white">Growth Regulators</span>
          </div>
        </div>
      </div>
    </div>
