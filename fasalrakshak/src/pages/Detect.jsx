...
const Detect = () => {
  ...
  const executeAnalysis = async () => {
    ...
    try {
      ...
      // 4. Handle Not A Plant constraint
            ...
            <div className="flex flex-col md:flex-row gap-6 mt-6 px-4 pb-4 md:px-8 md:pb-8">
              <div className="md:w-1/3 flex-shrink-0">
                <div className="w-full h-[160px] md:h-full rounded-2xl overflow-hidden border-2 border-[#E0EDD5] relative shadow-sm">
                  ...
                  <div className="absolute bottom-3 left-3 bg-primary-green text-white font-nunito font-bold text-[14px] px-3 py-1 rounded-full shadow-sm">
                    🌿 Detected: {analysisResult.cropName}
                  </div>
                </div>
              </div>
  ...
  return (
    <div className="min-h-screen bg-white font-nunito flex flex-col pt-20">
      {/* 1. Header Banner */}
      <motion.div 
          ...
          {currentState === 'RESULTS' && analysisResult && (
            ...
            >
              {analysisResult.healthStatus === 'diseased' && (
                <>
                  <SymptomsCard result={analysisResult} />
                  <TreatmentPlanCard result={analysisResult} />
                </>
              )}
